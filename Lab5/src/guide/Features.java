...
public class Features {
    ...
    public String posFollowing;
    public String posBefore;
    boolean canLA;
    boolean canRE;
    
    /* one of them being the part of speech of the word following the top of the stack in the sentence order. */
    ...
    public Features(String topPostagStack, String secondPostagStack, String firstPostagQueue, String secondPostagQueue, String posFollowing, String posBefore, boolean canLA, boolean canRE) {
        this.topPostagStack = topPostagStack;
        this.secondPostagStack = secondPostagStack;
        this.firstPostagQueue = firstPostagQueue;
        this.secondPostagQueue = secondPostagQueue;
        this.posFollowing = posFollowing;
