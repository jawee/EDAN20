...
public class Constants {
    ...
    public final static String NIVRE_HOME = "/Users/andreasolsson/Dropbox/Skola/LanguageTechnology/Lab5/";
    ...
    public final static String ARFF_MODEL = NIVRE_HOME + "model.model";
